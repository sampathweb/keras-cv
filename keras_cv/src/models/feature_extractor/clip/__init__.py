...
from keras_cv.src.models.feature_extractor.clip.clip_processor import CLIPProcessor
from keras_cv.src.models.feature_extractor.clip.clip_text_model import (
    CLIPTextEncoder,
)
from keras_cv.src.models.feature_extractor.clip.clip_tokenizer import CLIPTokenizer
